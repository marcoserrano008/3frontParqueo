...
export default function ReporteDinero() {
  ...
  const [dineroIngresos, setDineroIngresos] = useState("-")
  const [dineroIngresosEspacio, setDineroIngresosEspacio] = useState("-")
  ...
  const columnsEspacio = [
   ...
   const generarReporte = () => {
    ...
    axiosClient.post('/cobros-por-fecha', dataToSend)
    .then(response => {
      console.log(response.data);
      setData(response.data.data)
      setDineroIngresos(response.data.total)
  ...
  const generarReporteEspacio = () => {
    ...
    axiosClient.post('/cobros-por-fecha-espacio', dataToSend)
    .then(response => {
      console.log(response.data);
      setDataEspacio(response.data.data)
      setDineroIngresosEspacio(response.data.total)
  ...
  return (
    <>
      <div className='flex flex-row'>
        <div className='flex w-1/2 text-2xl font-extrabold'>Reporte Dinero</div>
      ...
      <div className='flex-grow'>
        <div className='flex justify-center content-center'>
          <Tabs defaultValue="general" className='mt-10 w-[1400px]'>
            ...
            <TabsContent value="general">
              <Card>
                <CardHeader>
                  <CardTitle>
                    Ver Ingresos de dinero de todo el parqueo
                  </CardTitle>
                  <CardDescription>
                    Lista de ingresos detallados en todo el parqueo
                  </CardDescription>
                </CardHeader>
                  ...
                  <div className='flex justify-center content-center'>
                    <div className="flex flex-col">
                      ...
                      <div className='flex-grow text-slate-500'>
                        Ver los ingresos por intervalo de fecha, seleccione un intervalo.
                      </div>
                      <div className='flex justify-center content-center'>
                      ...
                      <div className='flex justify-center content-center  '>
                        <div className='flex mt-5 '>
                          <Card className='w-[580px]'>
                            ...
                            <CardContent>
                              <div className="text-2xl font-bold">Bs. {dineroIngresos}</div>
                          ...
                          <div className='flex justify-center content-center  '>
                            <div className='flex mt-5 '>
                              <Card className='w-[580px]'>
                                ...
                                <CardContent>
                                  <div className="text-2xl font-bold">Bs. {dineroIngresosEspacio}</div>
                                  <p className="text-xs text-muted-foreground">
